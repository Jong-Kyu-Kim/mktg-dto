...
const Promotion = () => {
  return (
    <Layout>
      ...
      <DataContainer title={`${category} 상세내역`} category={category} type="effect" target={['subcategory', 'title', 'value']} fromDate={fromDate} sort="value">
        <VerticalBarChart />
      </DataContainer>
      ...
      <DataContainer title={`활동별 ${category} 내역`} category={category} type="activity" fromDate={fromDate} target={['date', 'subcategory', 'title']}>
        <HorizontalBarchart />
      </DataContainer>

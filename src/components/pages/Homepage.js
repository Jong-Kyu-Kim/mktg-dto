...
const Homepage = () => {
  return (
    <Layout>
      ...
      <DataContainer title={`${category} 상세내역`} category={category} type="effect" target={['title', 'subcategory', 'value']} sort="value">
        <VerticalBarChart />
      </DataContainer>

      <DataContainer title={`${category} Effect Logs`} category={category} type="effect" target={['date', 'subcategory', 'title']} sort="date">
